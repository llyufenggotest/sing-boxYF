...
struct Application: App {
    ...
    init() {
        ...
        _environments = StateObject(wrappedValue: ExtensionEnvironments())
        _peerStore = StateObject(wrappedValue: TailscaleSSHPeerStore())
        _tailscaleViewModel = StateObject(wrappedValue: TailscaleStatusViewModel())
        _taildropSendManager = StateObject(wrappedValue: TaildropSendManager())
        _taildropInbox = StateObject(wrappedValue: TaildropInboxViewModel())
        Task { @MainActor in
